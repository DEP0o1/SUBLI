...
INSERT INTO evento VALUES ('Palestra Aberta', 6,NOW(), 'O evento começou com uma palestra de abertura ministrada por uma autora convidada, que compartilhou histórias sobre seu processo criativo e discutiu a importância da literatura em tempos de transformação social. Em seguida, os participantes circularam entre diferentes estações: a feira de livros, com exemplares novos e raros; a sala de contação de histórias, onde crianças se reuniam em almofadas coloridas; e o espaço de leitura silenciosa, perfeito para quem buscava alguns minutos de tranquilidade.', 1,'pedro@gmail.com', false);
