...
class BibliotecaController extends Banco
{
    function ListarBibliotecas($biblioteca = new Biblioteca())
    {
        ...
        $bibliotecariocontroller = new BibliotecarioContoller;
        $dados = $this->Consultar('listar_bibliotecas', $parametros);
            foreach($dados as $item){
            $Biblioteca = new Biblioteca;
            $Biblioteca->Hydrate($item);
            $Biblioteca->bibliotecarios = $bibliotecariocontroller->ListarBibliotecarios(new Bibliotecario(null,null,null,null,$Biblioteca->cd_bibliotecario));
